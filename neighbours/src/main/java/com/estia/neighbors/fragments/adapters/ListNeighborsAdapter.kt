...
class ListNeighborsAdapter( items: List<Neighbor>,private val handler: ListNeighborHandler ) : RecyclerView.Adapter<ListNeighborsAdapter.ViewHolder>() {
...
// Display Neighbour Avatar
        ...
        holder.mDeleteButton.setOnClickListener {
            handler.onDeleteNeighbor(neighbour)
        }
    }
